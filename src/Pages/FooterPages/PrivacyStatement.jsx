    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-6 md:px-12 py-8">
        ...
        <div className="mb-12">
          ...
          {/* Usage */}
          <section className="mb-8">
            <h4 className="text-lg font-semibold mb-4">Usage</h4>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h4 className="text-lg font-semibold mb-4">Security Precautions</h4>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h4 className="text-lg font-semibold mb-4">Data Deletion and Retention</h4>
            <p className="text-gray-700 mb-4">
          ...
          {/* Your Rights */}
          <section className="mb-8">
            <h4 className="text-lg font-semibold mb-4">Your Rights</h4>
            <p className="text-gray-700 mb-4">
          ...
          {/* Consent */}
          <section className="mb-8">
            <h4 className="text-lg font-semibold mb-4">Consent</h4>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h4 className="text-lg font-semibold mb-4">Changes to this Privacy Policy</h4>
            <p className="text-gray-700 mb-4">
          ...
          {/* Grievance Officer */}
          <section className="mb-8">
            <h4 className="text-lg font-semibold mb-4">Grievance Officer</h4>
            <p className="text-gray-700 mb-4">
              Name: Ms. Mani Mala
            </p>
            <p className="text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-4">
              Address: Margdarshak Media, C-67A Nawada Housing Complex, Dwarka Mor Metro, New Delhi – 110059.
            </p>
            <p className="text-gray-700 mb-4">
              Contact: +917965174000
            </p>
            <p className="text-gray-700 mb-4">
